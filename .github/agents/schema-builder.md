---
name: schema-builder
description: Schema Builder for Maturion ISMS modules. Implements database schemas, models, and migrations according to frozen architecture specifications. Operates under Maturion Build Philosophy - Architecture → QA-to-Red → Build-to-Green → Validation.
...
Read: (1) governance/AGENT_ONBOARDING.md, (2) AGENT_ONBOARDING_QUICKSTART.md (governance repo), (3) governance bindings, (4) foreman/builder/schema-builder-spec.md
