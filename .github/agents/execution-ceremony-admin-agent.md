...
metadata:
  ...
  contract_version: 1.0.0
  change_summary: "v1.0.0 (2026-04-13): Initial AMC instance. Layer-down from ISMS v1.2.0. Ref: app_management_centre#1067."
---
...
Read `.governance-pack/CANON_INVENTORY.json`. Verify hashes. If any null or unresolvable hash detected → **HALT-002. Return to Foreman.**
...
**Version**: 1.0.0 | **Contract**: 1.0.0 | **Last Updated**: 2026-04-13
