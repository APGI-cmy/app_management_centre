...
|---|---|---|---|---|
| B1 | Applicable executable RED tests and observed intended-RED evidence are not committed. IAA finding `IAA-1229-B1-TRACE-001` also found six mislabeled IDs in the earlier W1 map; PR #1229 corrects those meanings and separates W1 GREEN duties from W7 cross-wave RED guards. | Stage 6 QA pack; corrected W1 RED map; `QA-DEPLOY-001/002/003/004/006/007/010`; `QA-CONFIG-001/002/003`; exact QA-DES rows in the gap analysis | **BLOCKING** | Proposed Issue #1226; CS2-authorized QA-builder lane required. `db-migrate.yml`, migration GREEN proof and health/smoke GREEN proof remain W7. |
