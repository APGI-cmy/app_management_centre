...
| **ARC Governance Console** | Dedicated ARC (Automated Response Control) governance surface — initiating, routing, approving, and auditing ARC-triggered governance actions. ARC is not a subset of general intervention flows; it is a named domain with its own surface and wiring | FRS FR-1800 family, TRS TR-300, Architecture, UI |
...
| **Dynamic Upload Quota Management** | Operational quota console — live quota state, quota adjustment approvals, threshold alerts, full audit trail. This is an operational control surface, not a read-only view | FRS FR-603/FR-606/FR-607, TRS TR-800, Architecture, UI |
