...
For `APGI-cmy/app_management_centre`, the layer-down must specifically review and update:

- `.admin/pr.json.schema.json` — extend schema with `execution_model` and companion fields
- `.github/scripts/validate-simple-pr-admin.sh` — add Check 13 enforcement
...
*Layered down to APGI-cmy/app_management_centre from APGI-cmy/maturion-foreman-governance commit 77a8297bc2408bbc1c224083fd6028affb052107*
