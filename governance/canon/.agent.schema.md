...
3. **Use visual markers**: 🔒 emoji, "(LOCKED)" suffix, HTML comment boundaries
...
- **Pre-Gate Release Validation** — Mandatory local gate execution before handover
- **Zero-Warning Handover Enforcement** — Mandatory zero-warning validation per EXECUTION_BOOTSTRAP_PROTOCOL.md v1.1.0 Section 5.1
